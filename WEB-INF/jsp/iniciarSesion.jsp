...
<%
    ...
    // Comprobamos si hubo un error en el inicio de sesión
    String error = (String)session.getAttribute("error-login");
%>
...
<form id="login-form" action="IniciarSesion" method="post">
    ...
    <p id="error-login" style="color:red"><%= error %></p>
</form>
<% } else { %>
<form id="login-form" action="CerrarSesion" method="get">
